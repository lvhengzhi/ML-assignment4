...
public class Main {
			...
			case ValueIteration:
				runAlgorithm(analysis, problem, domain, hashingFactory, initialState, new PlannerFactory() {
					...
					public Planner createPlanner(int episodeIndex, SADomain domain, HashableStateFactory hashingFactory, SimulatedEnvironment simulatedEnvironment) {
						return new ValueIteration(domain, 0.99, hashingFactory, 0.00001, episodeIndex);
					}
				}, algorithm);
				break;
			case PolicyIteration:
				runAlgorithm(analysis, problem, domain, hashingFactory, initialState, new PlannerFactory() {
					...
					public Planner createPlanner(int episodeIndex, SADomain domain, HashableStateFactory hashingFactory, SimulatedEnvironment simulatedEnvironment) {
						 ...
						 * iterations).
						 */
						return new PolicyIteration(domain, 0.99, hashingFactory, 0.00001, problem.getNumberOfIterations(Algorithm.ValueIteration), episodeIndex);
					}
				}, algorithm);
				break;
			default:
	...
	private static Problem createProblem2() {
		String[] map = new String[] {
				...
				"S00010001000100000100",
				"001M001010L1010S11010",
				"000010101000100010100",
				"01S01010101001S110100",
				"000000S00000100000000",
				"00S0000S1010100M10100",
				"000010101010001000100",
				"001010101011S01010000",
				"00100000100000001000M",
				"0110101M111010M110100",
				"0000101000M0000000100",
				"00L00010101010M000S00",
				"00001000101000101000L",
				"01S0000000100M1010100",
				"001010001010001000S00",
				"0000101S001L00S000000",
				"0000001S0000101010000",
				"0010L0000110100010100",
				"00100000001000100010S",
				"00000S00000000000000G",
